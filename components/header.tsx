...
import { ChevronDownIcon, SunIcon, MoonIcon, Edit, StarIcon } from "lucide-react";
...
const Header = () => {
    ...
    const isChatPage = pathname.startsWith("/u/chat");

    return (
        <>
            <header className={`flex sticky top-0 bg-background ${!isChatPage && 'pt-[8px]'} py-1.5 items-center px-2 md:px-2 gap-2 justify-between`}>
